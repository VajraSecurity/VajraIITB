...
#     while True:
# aws = np.load("C:/Users/91702/Desktop/Sem_9/ITU_hackathon/monday0_run4/aws_train_Brown.npy")
# gfs = np.load("C:/Users/91702/Desktop/Sem_9/ITU_hackathon/monday0_run4/xtrainBrown.npy")
# encoding = np.load("C:/Users/91702/Desktop/Sem_9/ITU_hackathon/monday0_run4/encoding_train_Brown.npy")  

# aws = np.asarray(aws, dtype=np.float32)
# gfs = np.asarray(gfs, dtype=np.float32)
# encoding = np.asarray(encoding, dtype=np.float32)

# scaler_center = np.load("C:/Users/91702/Desktop/Sem_9/ITU_hackathon/monday0_run4/gfs_scaling_center.npy")
# scaler_scale = np.load("C:/Users/91702/Desktop/Sem_9/ITU_hackathon/monday0_run4/gfs_scaling_scale.npy")

# scaler_center = np.asarray(scaler_center, dtype=np.float32)
# scaler_scale = np.asarray(scaler_scale, dtype=np.float32)

# for i in range(gfs.shape[0]):
#     give_output((gfs[i]*scaler_scale)+scaler_center, aws[i], encoding[i])
